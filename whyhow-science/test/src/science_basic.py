...
def main():
    try:
        ...
        seed_questions = ["What is meta-stability?", "How are networks related to meta-stability?", "What does meta-stability provide?",
                          "How is meta-stability related to ecology?", "Why is meta-stability important?", "What is network sparsity for meta-stability?",
                          "What are the core concepts?"]
        print(f"{current_time()} - Creating graph from questions...")
        start_time = time.time()
        
        extracted_graph = client.graph.create_graph(namespace, seed_questions)
        ...
        print(f"{current_time()} - Waiting for 10 seconds for the graph to be created...")
        time.sleep(10)

        # Query the graph
        query_list = ["What are the core concepts?", "What is meta-stability?", "How does the network play a role in meta-stability?",
                       "What are the details of meta-stable networks?", "What is the significance of network sparsity for meta-stability?"]
